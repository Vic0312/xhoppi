    ...
    <body>
        ...
        <section class="container">
            <form method="POST" action="../processamento/processamento.php">
                <p id="cadastro_titulo"><b>Cadastrar Cliente</b></p>
                
                <input type="text" id="nome" placeholder="Nome" name="inputNome">

                <input type="text" id="sobrenome" placeholder="Sobrenome" name="inputSobrenome">

                <input type="text" id="cpf" placeholder="CPF" name="inputCPF">

                <input type="date" id="data_nasc" name="inputDataNasc">

                <input type="tel" id="tel" placeholder="Telefone" name="inputTelefone">

                <input type="email" id="email" placeholder="Email" name="inputEmail">

                <input type="password" id="senha" placeholder="Senha" name="inputSenha">
