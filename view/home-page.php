...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="rossel" src="../img/carrossel1.jpg" class="d-block w-100" alt="...">
    </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <center><img id="img1a" src="../img/banner1acompra.png"></center>

        <center><p id="p1">descobertas do dia</p></center>
