    ...
    <section class="area-container">
        ...
        <section class="container">
            ...
            <form method="POST"
                ...
                <input type="text"
                       id="fabricante"
                       name="inputFabricanteProd"
                       placeholder="Fabricante"
                       required>

                <input type="text"
                       id="descri"
                       name="inputDescricaoProd"
                ...
                <p id="selecionar">
                    <b>Selecionar foto do produto:</b>
                </p>
    ...
    <footer>
        ...
        <section class="container-footer">
            ...
            <section>
                ...
                <a>
                    <img class="imgpg" src="../img/logos.png">
                </a>
            ...
            <section>
                ...
                <p class="p-rdp">
                    <img class="icon" src="../img/twiter.png">
                    Twitter
                </p>
                ...
                <p class="p-rdp">
                    <img class="icon" src="../img/youtube.avif">
                    YouTube
                </p>
            ...
            <section>
                ...
                <p class="p-rdp">
                    <img class="qr" src="../img/qrcode.webp">
                </p>

                <p class="p-rdp">
                    <img class="stre" src="../img/gplogo.png">
                </p>

                <p class="p-rdp">
                    <img class="stre" src="../img/applogo.png">
                </p>
